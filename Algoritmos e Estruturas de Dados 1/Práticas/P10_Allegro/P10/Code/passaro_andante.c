...
int main(int argc, char **argv){
    ...
    while(bird_x < SCREEN_W)
    {
        ...
        if(redraw && al_is_event_queue_empty(event_queue)) {
            ...
            al_draw_bitmap(bird, bird_x, bird_y, 0);//al_draw_bitmap(bird, bird_x, bird_y+30*sin(bird_x/10.0), 0);//al_draw_bitmap(bird, bird_x, bird_y, 0);
